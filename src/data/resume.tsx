...
export const DATA = {
  ...
  summary:
    "I’m a cs graduate who is obsessed with PC but works in MacBook. I love to build realtime solution and also spends my leisure time watching Japanese anime or American cartoons.",
  avatarUrl: "/me.jpg",
  skills: [
    "React",
    "React Native",
